...
class Welcome extends CI_Controller {
	...
	public function pdfcheck() { 
	    ...
	    $mpdf = new  Mpdf\Mpdf();
	    $html = $this->load->view('pdfcheck',[],true);
	    $mpdf->WriteHTML($html);
	    $mpdf->Output();
	    ...
	    $data['getInfo'] = $this->m_fees->getContent('1');
	    $this->load->view('pdfcheck',$data); 
	}
	...
	public function save_pdf()
	{
	    ...
	    //now pass the data//
	    $data['getInfo'] = $this->m_fees->getContent('1');
	    $html=$this->load->view('pdfcheck',$data, true); //load the pdf.php by passing our data and get all data in $html varriable.
